...
const SkillCard = ({ title, skills }: { title: string; skills: Skill[] }) => (
  <div className="bg-bg p-10 rounded-[2rem] border border-transparent transition-all duration-[400ms] hover:bg-transparent hover:border-bg-variant cursor-default md:p-8 md:w-4/5 md:mx-auto sm:w-full sm:p-7">
